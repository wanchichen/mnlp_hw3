...
<tr>
<th>Slovak (Input)</th>
<th>Reference (Google Translate)</th>
<th>Candidate (GPT-3)</th>
<th>BLEU Score</th>
</tr>
</thead>
<tbody>
<tr>
<td>Dnes si môžeme ísť kúpiť oblečenie do nákupného centra, ale nebudeme sa tam môcť najesť</td>
<td>Today we can go to the mall to buy clothes, but we will not be able to eat there</td>
<td>Today we can go to the mall to buy clothes, but we cannot eat there</td>
<td>0.6313</td>
</tr>
<tr>
<td>O druhej poobede budem doma na obed</td>
<td>I will be home for lunch at two in the afternoon</td>
<td>I'll be home for lunch at 2 o'clock</td>
<td>0.3553</td>
</tr>
<tr>
<td>Môžete mi poslať e-mail s dátumom a časom stretnutia?</td>
<td>Can you send me an email with the date and time of the meeting?</td>
<td>Can you send me an email with the date and time of our meeting?</td>
<td>0.8555</td>
</tr>
<tr>
<td>Keď sa skončí hokej, mali by sme ísť hrať hokej</td>
<td>When hockey is over, we should go play hockey</td>
<td>When hockey ends we should go play hockey</td>
<td>0.5247</td>
</tr>
<tr>
<td>Kúpim chladničku za sto dolárov</td>
<td>I'll buy a refrigerator for a hundred dollars</td>
<td>I want to buy a refrigerator for $100</td>
<td>0.3457</td>
</tr>
<tr>
<td>Musím sa učiť na test z biológie</td>
<td>I have to study for a biology test</td>
<td>I have to study for a biology test</td>
<td>1.0</td>
</tr>
<tr>
<td>Poďme do parku a zahrajme si futbal</td>
<td>Let's go to the park and play football</td>
<td>Let's go to the park and play football</td>
<td>1.0</td>
</tr>
<tr>
<td>Môžeme mať na večeru kuracie mäso?</td>
<td>Can we have chicken for dinner?</td>
<td>Can we have chicken for dinner?</td>
<td>1.0</td>
</tr>
<tr>
<td>Tento víkend som išiel do domu svojich priateľov a hral videohry</td>
<td>This weekend I went to my friends' house and played video games</td>
<td>This weekend I went to my friends' house and played video games</td>
<td>1.0</td>
</tr>
<tr>
<td>Veľmi sa teším, keď ich zajtra uvidím hrať na koncerte</td>
<td>I'm very happy to see them play at the concert tomorrow</td>
<td>I'm very looking forward to seeing them play at the concert tomorrow</td>
<td>0.4833</td>
</tr>
</tbody>
</table>
<h2 id="conclusion" tabindex="-1"><a class="header-anchor" href="#conclusion" aria-hidden="true">#</a> Conclusion</h2>
<p>From this blog, we see that GPT-3 is extremely powerful and can perform better on some NLP tasks than even the state-of-the-art fine-tuned models. GPT-3 is not trained to do anything specific task; rather, it is pretrained on a massive dataset consisting of over a trillion words. When used for a specific task, the model is able to take zero, one, or a few demonstrations of the task depending on the type of experiment you want to conduct. This is ultimately what gives it the flexiblity to be applied to a variety of different domains within NLP.</p>
<p>For language translation specifically, it achieved BLEU scores slightly below that of some supervised NMT models. This is incredible, given it is not fine-tuned or trained for machine tranlation. When increasing from zero-shot to one-shot to few-shot, GPT-3 performed significantly better and better in translating between languages. It performed best when translating to English because the CommonCrawl dataset used to train GPT-3 contained English words 93% of the time, and foreign words 7% of the time. In my specific case study of translating Slovak into English, the model achieved an average BLEU score of 0.7196 using a few-shot setting.</p>
<p>In my opinion, even though GPT-3 is the latest and greatest language model to date, there is still room for improvement for these novel large-scale models. While GPT-3 proved that one pre-trained model can perform many NLP tasks and generate impressive results, it still lacks the ability to extract meaning and comprehension from text. Its synthesis techniques are gramatically sound and readable, but its contextual meaning is often repetitive, incoherent, and occasionaly contradictory. There are hypotheses that bidirectional encoder models could solve these sort of comprehension issues and create another incredible model, but until we figure out a way to truly extract meaning and generate long text that gives us coherent information, I believe GPT-3 will remain the status qou for generative language models.</p>
<h2 id="references" tabindex="-1"><a class="header-anchor" href="#references" aria-hidden="true">#</a> References</h2>
<p>[1]<a href="https://arxiv.org/abs/2005.14165" target="_blank" rel="noopener noreferrer"><em> Language Models are Few-Shot Learners </em><ExternalLinkIcon/></a></p>
<p>[2]<a href="https://arxiv.org/abs/1706.03762" target="_blank" rel="noopener noreferrer"><em> Attention Is All You Need </em><ExternalLinkIcon/></a></p>
</div></template>
